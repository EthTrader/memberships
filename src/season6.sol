...
contract EthTraderSpecialMembershipSeason6 is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    constructor() ERC721("EthTrader Special Membership (S06)", "ETSMS06") {        
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://raw.githubusercontent.com/EthTrader/memberships/main/meta/season_06.json";
    }
    ...
    function isSeasonActive() public view returns (bool) {
        // season 6 >= 2025/06/04 && < 2025/07/30
        return block.timestamp >= 1749016800 && block.timestamp < 1753855200;
    }
