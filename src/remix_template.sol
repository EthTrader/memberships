...
contract EthTraderSpecialMembershipSeason3 is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://raw.githubusercontent.com/EthTrader/memberships/main/meta/season_03.json";
    }
    ...
    function isSeasonActive() public view returns (bool) {
        // season 3 >= 2024/12/18 && < 2025/02/12
        return block.timestamp >= 1734501600 && block.timestamp < 1739340000;
    }
