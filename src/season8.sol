...
contract EthTraderSpecialMembershipSeason8 is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    constructor() ERC721("EthTrader Special Membership (S08)", "ETSMS08") {        
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://raw.githubusercontent.com/EthTrader/memberships/main/meta/season_08.json";
    }
    ...
    function isSeasonActive() public view returns (bool) {
        // season 8 >= 2025/09/24 && < 2025/11/19
        return block.timestamp >= 1758693600 && block.timestamp < 1763532000;
    }
