...
contract EthTraderSpecialMembershipSeason9 is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://raw.githubusercontent.com/EthTrader/memberships/main/meta/season_09.json";
    }
    ...
    function isSeasonActive() public view returns (bool) {
        // season 9 >= 2025/11/19 && < 2026/01/26
        return block.timestamp >= 1763532000 && block.timestamp < 1768370400;
    }
